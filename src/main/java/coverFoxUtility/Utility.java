...
public class Utility {
	...
	IOException {
		...
		// File dest= new File("D:\\new//eclipse\\Automation8thJune_Selenium\\screenShot\\"+fileName+timeStamp+".png");
		File dest = new File(System.getProperty("user.dir") + "\\screenShot\\" +fileName + timeStamp + ".png");FileHandler.copy(source, dest);
	}
